...
import { ArrowLeft, Save, Calendar, MapPin, Tag, Image, FileText } from '@/components/Icons';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const eventData = {
        ...
        category: formData.category as 'conference' | 'workshop' | 'seminar' | 'lecture' | 'competition',
